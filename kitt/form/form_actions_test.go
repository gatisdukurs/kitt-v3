...
func Test_Form_Actions(t *testing.T) {
	t.Run("it renders", func(t *testing.T) {
		...
		assertEqual(t, fa.Render(), `<div class="actions" id="form-actions"><button type="button" class="btn" id="button" name="button" value="">button</button></div>`)
	})
	...
	t.Run("it renders actions", func(t *testing.T) {
		...
		assertEqual(t, fa.RenderActions(), `<button type="button" class="btn" id="button" name="button" value="">button</button><button type="button" class="btn" id="button1" name="button1" value="">button1</button>`)
	})
